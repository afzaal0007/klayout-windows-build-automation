...
public:
    ...
    void setupUi(QWidget *CIFWriterOptionPage)
    {
        if (CIFWriterOptionPage->objectName().isEmpty())
            CIFWriterOptionPage->setObjectName("CIFWriterOptionPage");
        ...
        blank_separator_cbx->setObjectName("blank_separator_cbx");
        ...
        dummy_calls_cbx->setObjectName("dummy_calls_cbx");
    ...
    {
        CIFWriterOptionPage->setWindowTitle(QCoreApplication::translate("CIFWriterOptionPage", "Form", nullptr));
        groupBox->setTitle(QCoreApplication::translate("CIFWriterOptionPage", "CIF Writer Options", nullptr));
        blank_separator_cbx->setText(QCoreApplication::translate("CIFWriterOptionPage", "If checked, a blank character is used as x/y coordinate\n"
"separator. Otherwise a comma is used.", nullptr));
        label_2->setText(QCoreApplication::translate("CIFWriterOptionPage", "Blank as x/y separator", nullptr));
        label->setText(QCoreApplication::translate("CIFWriterOptionPage", "Dummy cell calls", nullptr));
        dummy_calls_cbx->setText(QCoreApplication::translate("CIFWriterOptionPage", "If checked, dummy cell calls are added on global level", nullptr));
    } // retranslateUi
