...
public:
    ...
    void setupUi(QWidget *DXFReaderOptionPage)
    {
        if (DXFReaderOptionPage->objectName().isEmpty())
            DXFReaderOptionPage->setObjectName("DXFReaderOptionPage");
        ...
        circle_accuracy_le->setObjectName("circle_accuracy_le");
        ...
        polyline2poly_cbx->addItem(QString());
        polyline2poly_cbx->addItem(QString());
        polyline2poly_cbx->setObjectName("polyline2poly_cbx");
        ...
        text_scaling_le->setObjectName("text_scaling_le");
        ...
        render_texts_as_polygons_cbx->setObjectName("render_texts_as_polygons_cbx");
        ...
        contour_accuracy_le->setObjectName("contour_accuracy_le");
        ...
        keep_other_cells_cbx->setObjectName("keep_other_cells_cbx");
    ...
    {
        DXFReaderOptionPage->setWindowTitle(QCoreApplication::translate("DXFReaderOptionPage", "Form", nullptr));
        groupBox->setTitle(QCoreApplication::translate("DXFReaderOptionPage", "Input Options", nullptr));
        label->setText(QCoreApplication::translate("DXFReaderOptionPage", "LINE / POLYLINE", nullptr));
#if QT_CONFIG(tooltip)
        circle_accuracy_le->setToolTip(QCoreApplication::translate("DXFReaderOptionPage", "<html><head/><body><p>Specify this value to choose the number of points based on the accuracy requirement. If given, less points will be chosen if this choice is sufficient to fulfil the accuracy requirements.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        polyline2poly_cbx->setItemText(0, QCoreApplication::translate("DXFReaderOptionPage", "Automatic", nullptr));
        polyline2poly_cbx->setItemText(1, QCoreApplication::translate("DXFReaderOptionPage", "Keep lines", nullptr));
        polyline2poly_cbx->setItemText(2, QCoreApplication::translate("DXFReaderOptionPage", "Create polygons from closed polylines with width = 0", nullptr));
        polyline2poly_cbx->setItemText(3, QCoreApplication::translate("DXFReaderOptionPage", "Merge lines with width 0 into polygons", nullptr));
        polyline2poly_cbx->setItemText(4, QCoreApplication::translate("DXFReaderOptionPage", "Merge lines and auto-close open contours", nullptr));

        label_12->setText(QCoreApplication::translate("DXFReaderOptionPage", "# of points", nullptr));
        label_3->setText(QCoreApplication::translate("DXFReaderOptionPage", "\302\265m", nullptr));
        render_texts_as_polygons_cbx->setText(QCoreApplication::translate("DXFReaderOptionPage", "Render texts as polygons and do not create text objects", nullptr));
        label_6->setText(QCoreApplication::translate("DXFReaderOptionPage", "Arc interpolation", nullptr));
        label_9->setText(QCoreApplication::translate("DXFReaderOptionPage", "Keep all cells", nullptr));
        label_15->setText(QCoreApplication::translate("DXFReaderOptionPage", "Line merge accuracy in DXF units", nullptr));
        label_7->setText(QCoreApplication::translate("DXFReaderOptionPage", "Interpolation accuracy in DXF units", nullptr));
        label_11->setText(QCoreApplication::translate("DXFReaderOptionPage", "Scaling factor in percent", nullptr));
        label_4->setText(QCoreApplication::translate("DXFReaderOptionPage", "\302\265m", nullptr));
        label_5->setText(QCoreApplication::translate("DXFReaderOptionPage", "DXF file unit", nullptr));
        label_8->setText(QCoreApplication::translate("DXFReaderOptionPage", "Text to polygon", nullptr));
        keep_names_cbx->setText(QCoreApplication::translate("DXFReaderOptionPage", "Don't attempt to translate into layer/datatype numbers", nullptr));
        keep_other_cells_cbx->setText(QCoreApplication::translate("DXFReaderOptionPage", "Check this box to keep all cells, not only the top cell and its children", nullptr));
        label_13->setText(QCoreApplication::translate("DXFReaderOptionPage", "Keep layer names", nullptr));
        label_14->setText(QCoreApplication::translate("DXFReaderOptionPage", "Merge accuracy", nullptr));
        label_10->setText(QCoreApplication::translate("DXFReaderOptionPage", "Text scaling", nullptr));
        label_2->setText(QCoreApplication::translate("DXFReaderOptionPage", "Database unit   ", nullptr));
#if QT_CONFIG(tooltip)
        circle_points_le->setToolTip(QCoreApplication::translate("DXFReaderOptionPage", "<html><head/><body><p>Number of points per full circle used for arc interpolation (the accuracy may reduce the number if less are required)</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        label_16->setText(QString());
#if QT_CONFIG(tooltip)
        layer_subset_grp->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        layer_subset_grp->setTitle(QCoreApplication::translate("DXFReaderOptionPage", "Layer Subset And Layer Mapping", nullptr));
        read_all_cbx->setText(QCoreApplication::translate("DXFReaderOptionPage", "Read all layers (additionally to the ones in the mapping table)", nullptr));
    } // retranslateUi
