...
public:
    ...
    void setupUi(QWidget *CommonReaderOptionPage)
    {
        if (CommonReaderOptionPage->objectName().isEmpty())
            CommonReaderOptionPage->setObjectName("CommonReaderOptionPage");
        ...
        enable_text_cbx->setObjectName("enable_text_cbx");

        _2->addWidget(enable_text_cbx);

        enable_properties_cbx = new QCheckBox(groupBox);
        enable_properties_cbx->setObjectName("enable_properties_cbx");
    ...
    {
        CommonReaderOptionPage->setWindowTitle(QCoreApplication::translate("CommonReaderOptionPage", "Form", nullptr));
        groupBox->setTitle(QCoreApplication::translate("CommonReaderOptionPage", "Feature Subset", nullptr));
        enable_text_cbx->setText(QCoreApplication::translate("CommonReaderOptionPage", "Enable text objects", nullptr));
        enable_properties_cbx->setText(QCoreApplication::translate("CommonReaderOptionPage", "Enable properties", nullptr));
#if QT_CONFIG(tooltip)
        layer_subset_grp->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        layer_subset_grp->setTitle(QCoreApplication::translate("CommonReaderOptionPage", "Layer Subset And Layer Mapping", nullptr));
        read_all_cbx->setText(QCoreApplication::translate("CommonReaderOptionPage", "Read all layers (additionally to the ones in the mapping table)", nullptr));
    } // retranslateUi
