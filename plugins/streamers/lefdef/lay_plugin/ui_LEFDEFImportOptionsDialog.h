...
public:
    ...
    void setupUi(QDialog *LEFDEFImportOptionsDialog)
    {
        if (LEFDEFImportOptionsDialog->objectName().isEmpty())
            LEFDEFImportOptionsDialog->setObjectName("LEFDEFImportOptionsDialog");
        ...
        reader_options_pb->setObjectName("reader_options_pb");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, LEFDEFImportOptionsDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, LEFDEFImportOptionsDialog, qOverload<>(&QDialog::reject));
    ...
    {
        LEFDEFImportOptionsDialog->setWindowTitle(QCoreApplication::translate("LEFDEFImportOptionsDialog", "LEF Import Options", nullptr));
        reader_options_pb->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Options", nullptr));
        help_label->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "<html><body><a href=\"int:/about/lef_def_import.xml\">See here for details about LEF/DEF import</a></body></html>", nullptr));
        groupBox->setTitle(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Import Mode", nullptr));
        replace_rb->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Replace current layout", nullptr));
        import_same_panel_rb->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Import as new &layout in same panel", nullptr));
        import_new_panel_rb->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "I&mport as new layout in new panel", nullptr));
        label_6->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Import File", nullptr));
#if QT_CONFIG(tooltip)
        del_lef_files->setToolTip(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Delete selected files", nullptr));
#endif // QT_CONFIG(tooltip)
        del_lef_files->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "...", nullptr));
#if QT_CONFIG(tooltip)
        add_lef_file->setToolTip(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Add LEF file", nullptr));
#endif // QT_CONFIG(tooltip)
        add_lef_file->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "...", nullptr));
#if QT_CONFIG(tooltip)
        move_lef_files_up->setToolTip(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Move selected files up", nullptr));
#endif // QT_CONFIG(tooltip)
        move_lef_files_up->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "...", nullptr));
#if QT_CONFIG(tooltip)
        move_lef_files_down->setToolTip(QCoreApplication::translate("LEFDEFImportOptionsDialog", "Move selected files down", nullptr));
#endif // QT_CONFIG(tooltip)
        move_lef_files_down->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "...", nullptr));
        label_3->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "With LEF files:", nullptr));
        browse_pb->setText(QCoreApplication::translate("LEFDEFImportOptionsDialog", "...", nullptr));
    } // retranslateUi
