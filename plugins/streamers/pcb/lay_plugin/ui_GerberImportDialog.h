...
public:
    ...
    void setupUi(QDialog *GerberImportDialog)
    {
        if (GerberImportDialog->objectName().isEmpty())
            GerberImportDialog->setObjectName("GerberImportDialog");
        ...
        base_dir_le->setObjectName("base_dir_le");

        hboxLayout->addWidget(base_dir_le);

        base_dir_pb = new QToolButton(groupBox_4);
        base_dir_pb->setObjectName("base_dir_pb");
        ...
        free_mapping_cb->setObjectName("free_mapping_cb");
        ...
        layout_layers_tree->setObjectName("layout_layers_tree");
        ...
        move_target_layer_down_pb->setObjectName("move_target_layer_down_pb");
        const QIcon icon = QIcon(QString::fromUtf8(":/down_16px.png"));
        ...
        move_target_layer_up_pb->setObjectName("move_target_layer_up_pb");
        const QIcon icon1 = QIcon(QString::fromUtf8(":/up_16px.png"));
        ...
        delete_target_layer_pb->setObjectName("delete_target_layer_pb");
        const QIcon icon2 = QIcon(QString::fromUtf8(":/clear_16px.png"));
        ...
        add_target_layer_pb->setObjectName("add_target_layer_pb");
        const QIcon icon3 = QIcon(QString::fromUtf8(":/add_16px.png"));
        ...
        mounting_cbx->addItem(QString());
        mounting_cbx->setObjectName("mounting_cbx");
        ...
        artwork_files_tree->setObjectName("artwork_files_tree");
        ...
        drill_files_tree->setObjectName("drill_files_tree");
        ...
        free_files_tree->setObjectName("free_files_tree");
        ...
        move_free_file_up_pb->setObjectName("move_free_file_up_pb");
        ...
        add_free_file_pb->setObjectName("add_free_file_pb");
        ...
        move_free_file_down_pb->setObjectName("move_free_file_down_pb");
        ...
        delete_free_file_pb->setObjectName("delete_free_file_pb");
        ...
        free_layout_layers_tree->setObjectName("free_layout_layers_tree");
        ...
        free_move_target_layer_down_pb->setObjectName("free_move_target_layer_down_pb");
        ...
        free_move_target_layer_up_pb->setObjectName("free_move_target_layer_up_pb");
        ...
        free_delete_target_layer_pb->setObjectName("free_delete_target_layer_pb");
        ...
        free_add_target_layer_pb->setObjectName("free_add_target_layer_pb");
        ...
        reset_mapping_pb->setObjectName("reset_mapping_pb");
        ...
        free_layer_mapping_tree->setObjectName("free_layer_mapping_tree");
        ...
        layer_properties_file_le->setObjectName("layer_properties_file_le");

        gridLayout7->addWidget(layer_properties_file_le, 0, 0, 1, 1);

        layer_properties_file_browse_pb = new QToolButton(groupBox_2);
        layer_properties_file_browse_pb->setObjectName("layer_properties_file_browse_pb");
        ...
        border_le->setObjectName("border_le");
        ...
        dbu_lbl2->setObjectName("dbu_lbl2");
        ...
        const QIcon icon4 = QIcon(QString::fromUtf8(":/forward_24px.png"));
        ...
        const QIcon icon5 = QIcon(QString::fromUtf8(":/back_24px.png"));
        ...
        QObject::connect(import_pb, &QPushButton::clicked, GerberImportDialog, qOverload<>(&QDialog::accept));
        QObject::connect(cancel_pb, &QPushButton::clicked, GerberImportDialog, qOverload<>(&QDialog::reject));
    ...
    {
        GerberImportDialog->setWindowTitle(QCoreApplication::translate("GerberImportDialog", "PCB Import", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("GerberImportDialog", "Base Directory", nullptr));
        base_dir_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
        groupBox->setTitle(QCoreApplication::translate("GerberImportDialog", "Import Mode", nullptr));
        import_into_rb->setText(QCoreApplication::translate("GerberImportDialog", "Import into current layout (layers are added or overwritten)", nullptr));
        import_same_panel_rb->setText(QCoreApplication::translate("GerberImportDialog", "Import as new layout in same panel", nullptr));
        import_new_panel_rb->setText(QCoreApplication::translate("GerberImportDialog", "Import as new layout in new panel", nullptr));
        free_mapping_cb->setText(QCoreApplication::translate("GerberImportDialog", "Free layer mapping (allows one to specify arbitrary mapping between PCB files and layout layers)", nullptr));
        label_3->setText(QCoreApplication::translate("GerberImportDialog", "Specify the target layers \n"
"for the layout here.\n"
"\n"
...
"surface.", nullptr));
        ...
        ___qtreewidgetitem->setText(1, QCoreApplication::translate("GerberImportDialog", "Layer Specification", nullptr));
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("GerberImportDialog", "Type", nullptr));
#if QT_CONFIG(tooltip)
        move_target_layer_down_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Move selected layer down (Ctrl+Down)", nullptr));
#endif // QT_CONFIG(tooltip)
        move_target_layer_down_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        move_target_layer_down_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Ctrl+Down", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        move_target_layer_up_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Move selected layer up (Ctrl+Up)", nullptr));
#endif // QT_CONFIG(tooltip)
        move_target_layer_up_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        move_target_layer_up_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Ctrl+Up", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        delete_target_layer_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Delete selected layers (Delete)", nullptr));
#endif // QT_CONFIG(tooltip)
        delete_target_layer_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        delete_target_layer_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Del", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        add_target_layer_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Add new layer (Return)", nullptr));
#endif // QT_CONFIG(tooltip)
        add_target_layer_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        add_target_layer_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Return", nullptr));
#endif // QT_CONFIG(shortcut)
        mounting_cbx->setItemText(0, QCoreApplication::translate("GerberImportDialog", "Top Mounting", nullptr));
        mounting_cbx->setItemText(1, QCoreApplication::translate("GerberImportDialog", "Bottom Mounting", nullptr));

        label_33->setText(QCoreApplication::translate("GerberImportDialog", "Number of metal layers", nullptr));
        Number_of_via_layers->setText(QCoreApplication::translate("GerberImportDialog", "Number of via types", nullptr));
        label_28->setText(QCoreApplication::translate("GerberImportDialog", "Chip mounting", nullptr));
        label_32->setText(QCoreApplication::translate("GerberImportDialog", "Chip mounting determines the order by which the artwork layers are assigned to layout layers. \n"
"\n"
...
"For \"bottom\" mounting, the top PCB layer will be assigned to the last layout layer.", nullptr));
        ...
        ___qtreewidgetitem1->setText(1, QCoreApplication::translate("GerberImportDialog", "Artwork File", nullptr));
        ___qtreewidgetitem1->setText(0, QCoreApplication::translate("GerberImportDialog", "Index", nullptr));
#if QT_CONFIG(tooltip)
        artwork_files_tree->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        QTreeWidgetItem *___qtreewidgetitem2 = drill_files_tree->headerItem();
        ___qtreewidgetitem2->setText(3, QCoreApplication::translate("GerberImportDialog", "Drill File", nullptr));
        ___qtreewidgetitem2->setText(2, QCoreApplication::translate("GerberImportDialog", "Stop Layer", nullptr));
        ___qtreewidgetitem2->setText(1, QCoreApplication::translate("GerberImportDialog", "Start Layer", nullptr));
        ___qtreewidgetitem2->setText(0, QCoreApplication::translate("GerberImportDialog", "Index", nullptr));
        QTreeWidgetItem *___qtreewidgetitem3 = free_files_tree->headerItem();
        ___qtreewidgetitem3->setText(0, QCoreApplication::translate("GerberImportDialog", "Files", nullptr));
#if QT_CONFIG(tooltip)
        move_free_file_up_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Move selected layer up (Ctrl+Up)", nullptr));
#endif // QT_CONFIG(tooltip)
        move_free_file_up_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        move_free_file_up_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Ctrl+Up", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        add_free_file_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Add new layer (Return)", nullptr));
#endif // QT_CONFIG(tooltip)
        add_free_file_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        add_free_file_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Return", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        move_free_file_down_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Move selected layer down (Ctrl+Down)", nullptr));
#endif // QT_CONFIG(tooltip)
        move_free_file_down_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        move_free_file_down_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Ctrl+Down", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        delete_free_file_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Delete selected layers (Delete)", nullptr));
#endif // QT_CONFIG(tooltip)
        delete_free_file_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        delete_free_file_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Del", nullptr));
#endif // QT_CONFIG(shortcut)
        QTreeWidgetItem *___qtreewidgetitem4 = free_layout_layers_tree->headerItem();
        ___qtreewidgetitem4->setText(0, QCoreApplication::translate("GerberImportDialog", "Layer Specification", nullptr));
        label->setText(QCoreApplication::translate("GerberImportDialog", "Double-click the entry to edit the layer properties", nullptr));
#if QT_CONFIG(tooltip)
        free_move_target_layer_down_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Move selected layer down (Ctrl+Down)", nullptr));
#endif // QT_CONFIG(tooltip)
        free_move_target_layer_down_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        free_move_target_layer_down_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Ctrl+Down", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        free_move_target_layer_up_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Move selected layer up (Ctrl+Up)", nullptr));
#endif // QT_CONFIG(tooltip)
        free_move_target_layer_up_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        free_move_target_layer_up_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Ctrl+Up", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        free_delete_target_layer_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Delete selected layers (Delete)", nullptr));
#endif // QT_CONFIG(tooltip)
        free_delete_target_layer_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        free_delete_target_layer_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Del", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        free_add_target_layer_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Add new layer (Return)", nullptr));
#endif // QT_CONFIG(tooltip)
        free_add_target_layer_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        free_add_target_layer_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Return", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        reset_mapping_pb->setToolTip(QCoreApplication::translate("GerberImportDialog", "Clear settings for selected layers", nullptr));
#endif // QT_CONFIG(tooltip)
        reset_mapping_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
#if QT_CONFIG(shortcut)
        reset_mapping_pb->setShortcut(QCoreApplication::translate("GerberImportDialog", "Del", nullptr));
#endif // QT_CONFIG(shortcut)
        QTreeWidgetItem *___qtreewidgetitem5 = free_layer_mapping_tree->headerItem();
        ___qtreewidgetitem5->setText(0, QCoreApplication::translate("GerberImportDialog", "Layer Mapping", nullptr));
        label_22->setText(QCoreApplication::translate("GerberImportDialog", "Point 1", nullptr));
        label_24->setText(QCoreApplication::translate("GerberImportDialog", "y (micron)", nullptr));
        label_17->setText(QCoreApplication::translate("GerberImportDialog", "Reference points coordinates on PCB", nullptr));
        Point_3->setText(QCoreApplication::translate("GerberImportDialog", "Point 3", nullptr));
        label_18->setText(QCoreApplication::translate("GerberImportDialog", "Reference point coordinates in layout", nullptr));
        label_23->setText(QCoreApplication::translate("GerberImportDialog", "x (micron)", nullptr));
        label_25->setText(QCoreApplication::translate("GerberImportDialog", "Point 2", nullptr));
        label_26->setText(QCoreApplication::translate("GerberImportDialog", "Point 3", nullptr));
        label_21->setText(QCoreApplication::translate("GerberImportDialog", "Point 1", nullptr));
        label_20->setText(QCoreApplication::translate("GerberImportDialog", "y (micron)", nullptr));
        label_19->setText(QCoreApplication::translate("GerberImportDialog", "x (micron)", nullptr));
        label_27->setText(QCoreApplication::translate("GerberImportDialog", "Point 2", nullptr));
        label_30->setText(QCoreApplication::translate("GerberImportDialog", "Explicit transformation", nullptr));
#if QT_CONFIG(tooltip)
        explicit_trans_le->setToolTip(QCoreApplication::translate("GerberImportDialog", "Examples: \"r90\", \"m45\", \"r90 (2000,-5000)\"", nullptr));
#endif // QT_CONFIG(tooltip)
        label_31->setText(QCoreApplication::translate("GerberImportDialog", "(Reference points have higher priority)", nullptr));
        label_29->setText(QCoreApplication::translate("GerberImportDialog", "Leave fields empty to specify less reference points. One point is used to derive the displacement, further points are used to derive the orientation. Currently, no magnification is implied and only simple rotations are derived from the mapping points.\n"
"\n"
"Alternatively the transformation (imported to existing layout) can be specified using the explicit transformation below. This allows one to specify an arbitrary transformation. Use the common notation (i.e. \"*2 r90 10,-100\").", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("GerberImportDialog", "Layer Properties File", nullptr));
        label_5->setText(QCoreApplication::translate("GerberImportDialog", "Hint: this file is applied to the final layout. If PCB data is imported into an existing layout, the layer file should contain the previous layers as well.", nullptr));
        label_4->setText(QCoreApplication::translate("GerberImportDialog", "(leave empty to not load any file)", nullptr));
        layer_properties_file_browse_pb->setText(QCoreApplication::translate("GerberImportDialog", "...", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("GerberImportDialog", "Import Options", nullptr));
        label_2->setText(QCoreApplication::translate("GerberImportDialog", "Inverse layers", nullptr));
        label_16->setText(QCoreApplication::translate("GerberImportDialog", "Min. 4 points", nullptr));
        dbu_lbl2->setText(QCoreApplication::translate("GerberImportDialog", "Micron", nullptr));
        label_12->setText(QCoreApplication::translate("GerberImportDialog", "Merge polygons", nullptr));
        label_11->setText(QCoreApplication::translate("GerberImportDialog", "Number of points per circle   ", nullptr));
        dbu_lbl1->setText(QCoreApplication::translate("GerberImportDialog", "Database unit (for new layouts)   ", nullptr));
        topcell_lbl->setText(QCoreApplication::translate("GerberImportDialog", "Top cell name (for new layouts)    ", nullptr));
        label_7->setText(QCoreApplication::translate("GerberImportDialog", "... with a layout border of", nullptr));
        invert_cb->setText(QCoreApplication::translate("GerberImportDialog", "(Check to invert layer for negative contrast)", nullptr));
        merge_cb->setText(QCoreApplication::translate("GerberImportDialog", "(Check to remove all overlaps after importing)", nullptr));
        label_6->setText(QCoreApplication::translate("GerberImportDialog", "Micron", nullptr));
        next_pb->setText(QCoreApplication::translate("GerberImportDialog", "Next", nullptr));
        cancel_pb->setText(QCoreApplication::translate("GerberImportDialog", "Cancel", nullptr));
        import_pb->setText(QCoreApplication::translate("GerberImportDialog", "Import", nullptr));
        last_pb->setText(QCoreApplication::translate("GerberImportDialog", "Back", nullptr));
        section_header_lbl->setText(QCoreApplication::translate("GerberImportDialog", "SectionHeader", nullptr));
        file_menu->setText(QCoreApplication::translate("GerberImportDialog", "File ...", nullptr));
    } // retranslateUi
