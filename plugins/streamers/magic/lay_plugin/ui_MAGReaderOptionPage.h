...
public:
    ...
    void setupUi(QWidget *MAGReaderOptionPage)
    {
        if (MAGReaderOptionPage->objectName().isEmpty())
            MAGReaderOptionPage->setObjectName("MAGReaderOptionPage");
        ...
        merge_cbx->setObjectName("merge_cbx");
        ...
        lib_path->setObjectName("lib_path");
        ...
        del_lib_path->setObjectName("del_lib_path");
        QIcon icon;
        ...
        move_lib_path_down->setObjectName("move_lib_path_down");
        QIcon icon1;
        ...
        add_lib_path->setObjectName("add_lib_path");
        QIcon icon2;
        ...
        move_lib_path_up->setObjectName("move_lib_path_up");
        QIcon icon3;
        ...
        add_lib_path_with_choose->setObjectName("add_lib_path_with_choose");
    ...
    {
        MAGReaderOptionPage->setWindowTitle(QCoreApplication::translate("MAGReaderOptionPage", "Form", nullptr));
        groupBox->setTitle(QCoreApplication::translate("MAGReaderOptionPage", "Input Options", nullptr));
        label_6->setText(QCoreApplication::translate("MAGReaderOptionPage", "Lambda value", nullptr));
        label_7->setText(QCoreApplication::translate("MAGReaderOptionPage", "Micron", nullptr));
        keep_names_cbx->setText(QCoreApplication::translate("MAGReaderOptionPage", "Don't attempt to translate into layer/datatype numbers", nullptr));
        label_3->setText(QCoreApplication::translate("MAGReaderOptionPage", "Micron", nullptr));
        label_4->setText(QCoreApplication::translate("MAGReaderOptionPage", "Keep layer names", nullptr));
        label_2->setText(QCoreApplication::translate("MAGReaderOptionPage", "Database unit   ", nullptr));
        merge_cbx->setText(QCoreApplication::translate("MAGReaderOptionPage", "Merge boxes into polygons", nullptr));
        label->setText(QCoreApplication::translate("MAGReaderOptionPage", "Layout healing", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("MAGReaderOptionPage", "Library paths", nullptr));
#if QT_CONFIG(tooltip)
        del_lib_path->setToolTip(QCoreApplication::translate("MAGReaderOptionPage", "Delete selected paths", nullptr));
#endif // QT_CONFIG(tooltip)
        del_lib_path->setText(QCoreApplication::translate("MAGReaderOptionPage", "...", nullptr));
#if QT_CONFIG(tooltip)
        move_lib_path_down->setToolTip(QCoreApplication::translate("MAGReaderOptionPage", "Move selected paths down", nullptr));
#endif // QT_CONFIG(tooltip)
        move_lib_path_down->setText(QCoreApplication::translate("MAGReaderOptionPage", "...", nullptr));
#if QT_CONFIG(tooltip)
        add_lib_path->setToolTip(QCoreApplication::translate("MAGReaderOptionPage", "Add new a directory", nullptr));
#endif // QT_CONFIG(tooltip)
        add_lib_path->setText(QCoreApplication::translate("MAGReaderOptionPage", "...", nullptr));
        label_5->setText(QCoreApplication::translate("MAGReaderOptionPage", "Relative paths are resolved relative to the file read.\n"
"You can use expressions inside the path components for variable paths", nullptr));
#if QT_CONFIG(tooltip)
        move_lib_path_up->setToolTip(QCoreApplication::translate("MAGReaderOptionPage", "Move selected paths up", nullptr));
#endif // QT_CONFIG(tooltip)
        move_lib_path_up->setText(QCoreApplication::translate("MAGReaderOptionPage", "...", nullptr));
#if QT_CONFIG(tooltip)
        add_lib_path_with_choose->setToolTip(QCoreApplication::translate("MAGReaderOptionPage", "Add new a directory (file browser)", nullptr));
#endif // QT_CONFIG(tooltip)
        add_lib_path_with_choose->setText(QCoreApplication::translate("MAGReaderOptionPage", "...", nullptr));
#if QT_CONFIG(tooltip)
        layer_subset_grp->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        layer_subset_grp->setTitle(QCoreApplication::translate("MAGReaderOptionPage", "Layer Subset And Layer Mapping", nullptr));
        read_all_cbx->setText(QCoreApplication::translate("MAGReaderOptionPage", "Read all layers (additionally to the ones in the mapping table)", nullptr));
    } // retranslateUi
